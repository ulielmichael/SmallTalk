...
const qn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Ce = "copilot-", Ks = "24.6.4", Fc = "attention-required", Wc = "https://plugins.jetbrains.com/plugin/23758-vaadin", Zc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Gc(e) {
...
function Kn(e) {
  Promise.resolve().then(() => zl).then(({ showNotification: t }) => {
    t(e);
  });
}
function $s() {
...
function el(e) {
  return e.children && (e.children = e.children.filter(el)), e.visible !== !1;
}
class tl {
  constructor() {
...
const Jc = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, nl = (e) => {
  const t = [];
  let n = il(e);
  for (; n; )
...
function qe(e) {
  return !e || !(e instanceof HTMLElement) ? !1 : [...nl(e), e].map((t) => t.localName).some((t) => t.startsWith(Ce));
}
function Or(e) {
...
class sl {
  constructor() {
    this.dismissedNotifications = [], this.termsSummaryDismissed = !1, this.activationButtonPosition = null, this.paletteState = null, this.activationShortcut = !0, this.activationAnimation = !0, ln(this), this.initializer = new al(), this.initializer.promise.then(() => {
      Di(
        () => JSON.stringify(this),
        () => {
...
window.Vaadin.copilot._uiState = new tl();
window.Vaadin.copilot.eventbus = new Do();
window.Vaadin.copilot.overlayManager = new ol();
window.Vaadin.copilot._machineState = new sl();
window.Vaadin.copilot._previewState = new ll();
...
const te = (e) => new eo(typeof e == "string" ? e : e + "", void 0, Jn), dl = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: hl, defineProperty: vl, getOwnPropertyDescriptor: pl, getOwnPropertyNames: gl, getOwnPropertySymbols: bl, getPrototypeOf: ml } = Object, un = globalThis, Cr = un.trustedTypes, yl = Cr ? Cr.emptyScript : "", wl = un.reactiveElementPolyfillSupport, ct = (e, t) => e, Rn = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? yl : null;
      break;
  ...
  return n;
} }, to = (e, t) => !hl(e, t), Dr = { attribute: !0, type: String, converter: Rn, reflect: !1, hasChanged: to };
...
let Ue = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, n, r) {
    const { get: i, set: o } = pl(this.prototype, t) ?? { get() {
      return this[n];
    }, set(a) {
      this[n] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ct("properties"))) {
      const n = this.properties, r = [...gl(n), ...bl(n)];
  ...
  createRenderRoot() {
    ...
    return fl(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
...
Ue.elementStyles = [], Ue.shadowRootOptions = { mode: "open" }, Ue[ct("elementProperties")] = /* @__PURE__ */ new Map(), Ue[ct("finalized")] = /* @__PURE__ */ new Map(), wl?.({ ReactiveElement: Ue }), (un.reactiveElementVersions ??= []).push("2.0.4");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xn = globalThis, Xt = Xn.trustedTypes, Rr = Xt ? Xt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Yn = "$lit$", oe = `lit$${Math.random().toFixed(9).slice(2)}$`, Qn = "?" + oe, Ol = `<${Qn}>`, De = document, bt = () => De.createComment(""), mt = (e) => e === null || typeof e != "object" && typeof e != "function", $n = Array.isArray, no = (e) => $n(e) || typeof e?.[Symbol.iterator] == "function", mn = `[ 	
\f\r]`, tt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Vr = /-->/g, Ir = />/g, me = RegExp(`>|${mn}(?:([^\\s"'>=/]+)(${mn}*=${mn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), kr = /'/g, Lr = /"/g, ro = /^(?:script|style|textarea|title)$/i, io = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), ut = io(1), $c = io(2), he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Mr = /* @__PURE__ */ new WeakMap(), Ee = De.createTreeWalker(De, 129);
function oo(e, t) {
...
const ao = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    ...
    o += a === tt ? l + Ol : d >= 0 ? (r.push(c), l.slice(0, d) + Yn + l.slice(d) + oe + g) : l + oe + (d === -2 ? s : g);
  }
...
const Sl = { M: Yn, P: oe, A: Qn, C: 1, L: ao, R: so, D: no, V: Te, I: Ye, H: Nt, N: co, U: uo, B: lo, F: fo }, Nl = Xn.litHtmlPolyfillSupport;
Nl?.(yt, Ye), (Xn.litHtmlVersions ??= []).push("3.2.1");
const xl = (e, t, n) => {
...
let dt = class extends Ue {
  ...
  update(t) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = xl(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const _l = globalThis.litElementPolyfillSupport;
_l?.({ LitElement: dt });
(globalThis.litElementVersions ??= []).push("4.1.1");
class Pl extends El(dt) {
}
class Cl extends Pl {
  constructor() {
...
function Dl() {
  we.push(import("./copilot-log-plugin-Bby-9AJM.js")), we.push(import("./copilot-info-plugin-Dd9Uf7eD.js")), we.push(import("./copilot-features-plugin--cJASiBQ.js")), we.push(import("./copilot-feedback-plugin-CE9A5Xi3.js")), we.push(import("./copilot-shortcuts-plugin-Cjcd56q_.js"));
}
function Tl() {
  {
...
const Tt = new Vl(), w = window.Vaadin.copilot.eventbus;
if (!w)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const nt = window.Vaadin.copilot.overlayManager, ru = {
...
const kl = vo(Vn), fn = window.Vaadin.copilot._machineState;
if (!fn)
  throw new Error("Trying to use stored machine state before it was initialized");
const Ll = 5e3;
let zr = 1;
function go(e) {
  p.notifications.includes(e) && (e.dontShowAgain && e.dismissId && Ml(e.dismissId), p.removeNotification(e), w.emit("notification-dismissed", e));
}
function bo(e) {
...
function Ul(e) {
  ...
  p.setNotifications([...p.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    go(n);
  }, e.delay ?? Ll), w.emit("notification-shown", e);
}
const zl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  Re("Unspecified error", e), w.emit("vite-after-update", {});
}, Fl = (e, t) => e.error ? (Wl({
  error: e.error,
  ...
  Kn({
      ...
      ut`<vaadin-details summary="Details" style="color: var(--dev-tools-text-color)"
        ><div>
          <code class="codeblock" style="white-space: normal;color: var(--color)"
            ><copilot-copy></copilot-copy>${kl(t)}</code
          >
    ...
    delay: 3e4
  }), p.userInfo?.copilotProjectCannotLeaveLocalhost !== !0 && w.emit("system-info-with-callback", {
    callback: (i) => w.send("copilot-error", {
      message: e,
...
function Re(e, t) {
  Kn({
    ...
    details: e + (t ? `
${t}` : "")
  }), w.emit("system-info-with-callback", {
    callback: (n) => w.send("copilot-error", {
  ...
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Le.ERROR, message: n.map((r) => Gl(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function Gl(e) {
...
const Kl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  handleBrowserOperationError: Zl,
  handleCopilotError: Re,
  handleErrorDuringOperation: Bl,
  handleServerOperationErrorIfNeeded: Fl,
...
const Eo = () => {
  Hl().then((e) => p.setUserInfo(e)).catch((e) => Re("Failed to load userInfo", e));
}, Hl = async () => qn(`${Ce}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Jl = async () => Hi(() => p.userInfo), au = async () => (await Jl()).vaadiner;
w.on("copilot-prokey-received", (e) => {
  Eo(), e.preventDefault();
});
function Xl() {
...
const Fr = (e) => {
  ...
  if (e.shiftKey && e.code === "Space")
    ...
    w.emit("close-drawers", {}), p.setSpotlightActive(!1);
  } else !ec(e) && !t && nc(e) ? (w.emit("delete-selected", {}), e.preventDefault(), e.stopPropagation()) : (e.ctrlKey || e.metaKey) && e.key === "d" && !t ? (w.emit("duplicate-selected", {}), e.preventDefault(), e.stopPropagation()) : (e.ctrlKey || e.metaKey) && e.key === "b" && !t ? (w.emit("show-selected-in-ide", { attach: e.shiftKey }), e.preventDefault(), e.stopPropagation()) : (e.ctrlKey || e.metaKey) && e.key === "z" ? p.idePluginState?.supportedActions?.find((n) => n === "undo") && (w.emit("undoRedo", { undo: !e.shiftKey }), e.preventDefault(), e.stopPropagation()) : qe(e.target) && w.emit("keyboard-event", { event: e });
}, nc = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, ee = Ql(), su = {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oo = Symbol.for(""), rc = (e) => {
  if (e?.r === Oo) return e?._$litStatic$;
}, So = (e) => ({ _$litStatic$: e, r: Oo }), Wr = /* @__PURE__ */ new Map(), ic = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
  for (; c < r; ) {
    for (l = t[c]; c < r && (o = n[c], (i = rc(o)) !== void 0); ) l += i + t[++c], u = !0;
...
const { I: oc } = Sl, Zr = () => document.createComment(""), it = (e, t, n) => {
  ...
  return n;
}, ye = (e, t, n = e) => (e._$AI(t, n), e), ac = {}, sc = (e, t = ac) => e._$AH = t, lc = (e) => e._$AH, wn = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Gr = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    const i = lc(e), { values: o, keys: a } = this.dt(t, n, r);
    ...
    return this.ut = a, sc(e, l), he;
  }
}), kt = /* @__PURE__ */ new Map(), cc = (e) => {
...
const vc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), qr = { randomUUID: vc };
function xo(e, t, n) {
  ...
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, dc(r);
}
const Lt = [], st = [], uu = async (e, t, n) => {
  let r, i;
  t.reqId = xo();
...
function pc(e) {
  ...
  if (w.emitUnsafe({ type: e.command, data: e.data }))
    return !0;
  for (const t of Po())
    if (_o(t, e))
      return !0;
...
const Hr = new Cc(), Dc = "copilot-development-setup-user-guide";
function hu() {
  dn("use-dev-workflow-guide"), se.updatePanel(Dc, { floating: !0 });
}
function Co() {
  const e = p.jdkInfo;
...
var kc = Object.defineProperty, Lc = Object.getOwnPropertyDescriptor, Mc = (e, t, n, r) => {
  for (var i = r > 1 ? void 0 : r ? Lc(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = (r ? a(t, n, i) : a(i)) || i);
  return r && i && kc(t, n, i), i;
};
let Yr = class extends Cl {
  constructor() {
    ...
    }, this.operationInProgressCursorUpdateDebounceFunc = Pc(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
      qe(e.target?.owner) || (p.active || qe(e.detail.sourceEvent.target)) && e.preventDefault();
    }, this.mouseOverListener = () => {
      p.activatedFrom !== "test" && w.emit("set-pointer-events", { enable: !0 });
    }, this.mouseLeaveListener = () => {
      p.activatedFrom !== "test" && w.emit("set-pointer-events", { enable: !1 }), w.emit("close-drawers", {});
    };
  }
  static get styles() {
    return [
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-B5d4jiky.js"), await import("./copilot-init-step2-BQGt3JTy.js"), Il(), Dl(), this.tabIndex = 0, Tt.hostConnectedCallback(), window.addEventListener("keydown", Fr), w.onSend(this.handleSendEvent), this.removers.push(w.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
      w.on("open-attention-required-drawer", this.openDrawerIfPanelRequiresAttention.bind(this))
    ), this.removers.push(
      w.on("set-pointer-events", (t) => {
    ...
    ), yo(), this.initialized = !0, Rc();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    dn("activate"), Tt.activate(), Hr.copilotActivated(), Rl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.addEventListener("mouseover", this.mouseOverListener), nt.onCopilotActivation(), await Ic(), Ao.loadPreviewConfiguration(), this.active = !0;
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), Tt.deactivate(), Hr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.removeEventListener("mouseover", this.mouseOverListener), nt.onCopilotDeactivation(), this.active = !1;
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Tt.hostDisconnectedCallback(), window.removeEventListener("keydown", Fr), w.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), nt.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
  ...
  render() {
    return ut`
      ...
      ${this.renderDrawer("left")} ${this.renderDrawer("right")} ${this.renderDrawer("bottom")} ${uc()}
  ...
  closeDrawers() {
    ...
    const i = rl(r, "copilot-drawer-panel");
    if (!i) {
      e.forEach((o) => {
        o.opened = !1;
      });
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), gc();
  }
