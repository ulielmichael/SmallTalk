import { n as C, M as L, b as u, j as a, o as T, p as d, q as oe, r as D, u as B, v as R, O as X, A as I, w as b, x as l, y as ue, z as ge, B as J, D as G, E as p, F as ve, k as me, l as fe, P as be, G as we, I as ye, V as xe, H as Pe, J as se, K as $, L as H, N as Ie, Q as ae, R as K, S as re, T as Ae, U as Ce, W as ze, X as Se, Y as le, Z as ke, _ as $e, $ as De, a0 as de, a1 as ce, a2 as Le } from "./copilot-BgOYeZpG.js";
import { n as j, r as z } from "./state-DJX18EiL.js";
import { e as S, m as he } from "./overlay-monkeypatch-BdW-4rLP.js";
import { i as c } from "./icons-BYFh90d4.js";
/**
 * @license
...
var Re = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, k = (e, t, o, i) => {
...
var Oe = Object.defineProperty, _e = Object.getOwnPropertyDescriptor, pe = (e, t, o, i) => {
  for (var n = i > 1 ? void 0 : i ? _e(t, o) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (n = (i ? r(t, o, n) : r(n)) || n);
  return i && n && Oe(t, o, n), n;
};
...
const x = new Te();
var He = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, E = (e, t, o, i) => {
      ...
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && Ue("1.3.0", a.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : p}
...
window.Vaadin.copilot.plugins.push(Ne);
d.addPanel(Y);
var Je = Object.defineProperty, Ve = Object.getOwnPropertyDescriptor, Fe = (e, t, o, i) => {
  for (var n = i > 1 ? void 0 : i ? Ve(t, o) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (n = (i ? r(t, o, n) : r(n)) || n);
  return i && n && Je(t, o, n), n;
};
...
var qe = Object.defineProperty, Xe = Object.getOwnPropertyDescriptor, Ye = (e, t, o, i) => {
  for (var n = i > 1 ? void 0 : i ? Xe(t, o) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (n = (i ? r(t, o, n) : r(n)) || n);
...
var We = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, U = (e, t, o, i) => {
  for (var n = i > 1 ? void 0 : i ? Ge(t, o) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (n = (i ? r(t, o, n) : r(n)) || n);
...
let _ = class extends L {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: o } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(o - this.initialMouseDownPosition.y) > Ke;
      }
  ...
  generateItems() {
    const e = a.active, t = e && a.userInfo?.copilotProjectCannotLeaveLocalhost !== !0, o = e && !!a.idePluginState?.supportedActions?.find((n) => n === "undo"), i = [
      {
        text: "Vaadin Copilot",
        children: [
          { visible: e, component: "copilot-activation-button-user-info" },
...
var Ze = Object.defineProperty, Qe = Object.getOwnPropertyDescriptor, M = (e, t, o, i) => {
...
let A = class extends L {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      const { width: t, height: o } = this.getBoundingClientRect(), { left: i, top: n, bottom: s, right: r } = x.anchor(this), h = window.getComputedStyle(this.container), g = Number.parseInt(h.borderTopWidth, 10), v = Number.parseInt(h.borderBottomWidth, 10);
...
u.on("undoRedo", (e) => {
  const o = { files: e.detail.files ?? ze(), uiId: Se() }, i = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", n = e.detail.undo ? "undo" : "redo";
  le(n), et(X.RedoUndo), u.send(i, o);
});
var tt = Object.defineProperty, it = Object.getOwnPropertyDescriptor, nt = (e, t, o, i) => {
  for (var n = i > 1 ? void 0 : i ? it(t, o) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (n = (i ? r(t, o, n) : r(n)) || n);
